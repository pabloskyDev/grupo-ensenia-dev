    ...
    <div class="container text-center text-md-start mt-5 text-light">
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <ul>
            <i class="fas fa-home me-3">Envigado, Ant, Col</i>
            <i class="fas fa-envelope me-3">Grupoensena@gmail.com</i>
            <i class="fas fa-phone me-3">Fijo - 604 298 84 30</i>
            <i class="fas fa-print me-3">Cel - 324 431 90 79</i>
          </ul>
        </div>
      </div>
    </div>
